...
import os
import logging
from . import linter_pylint as pylint
...
class ViewMark:
    ...
    def apply(self):
        ...
        for severity in severities:
            ...
            # logger.debug(list(filter_marks(self.marks, severity)))
    ...
    def get_message(self, view: sublime.View, pos: "sublime.Point") -> None:
        ...
        if id_ in self.marks:
            ...
            if message: # for string
                formatted = ViewMark.format_html(message) if message else ""
                logger.debug(formatted)
                ViewMark.show_popup(view,formatted,flags=sublime.HIDE_ON_MOUSE_MOVE_AWAY,location=pos)
